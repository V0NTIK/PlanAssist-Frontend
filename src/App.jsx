                ...
                <div className="flex-1 overflow-hidden">
                  {workspaceTask.url ? (
                    <div className="relative w-full h-full">
                      ...
                      />
                      <div className="absolute top-4 left-1/2 transform -translate-x-1/2 bg-yellow-50 border border-yellow-200 rounded-lg p-4 shadow-lg max-w-md z-10">
                        <div className="flex items-start gap-3">
                          <AlertCircle className="w-5 h-5 text-yellow-600 flex-shrink-0 mt-0.5" />
                          <div>
                            <p className="text-sm text-gray-700 mb-3">
                              <strong>Note:</strong> Canvas may not load due to security restrictions. Click below to open in a new tab.
                            </p>
                            <a
                              href={workspaceTask.url}
                              target="_blank"
